...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a href="https://ai-thumbnail-generator-frontend-chi.vercel.app/generate" className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-pink-100 bg-pink-200/15"
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span> Generate your 1st thumbnail for free </span>
